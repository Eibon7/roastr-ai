...
class BatchRunner {
  ...
  async run() {
    try {
      ...
      console.log(`✅ Initialized ${initResult.success} integrations (${initResult.failed} failed)`);
      ...
      console.log(`📊 Final stats: ${batchResult.success}/${batchResult.processed} integrations successful`);
