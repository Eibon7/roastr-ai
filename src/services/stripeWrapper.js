    ...
    get subscriptions() {
        return {
            create: (params) => this.safeRequest(
                ...
                { customer: params?.customer, items: params?.items?.length }
            ),
            
            retrieve: (subscriptionId, params = {}) => this.safeRequest(
                () => this.stripe.subscriptions.retrieve(subscriptionId, params),
                'subscriptions.retrieve',
                { subscriptionId, expand: params.expand }
            ),
            
            update: (subscriptionId, params) => this.safeRequest(
            ...
            list: (params = {}) => this.safeRequest(
                ...
                'subscriptions.list',
                { customer: params.customer, limit: params.limit }
            ),

            cancel: (subscriptionId, params = {}) => this.safeRequest(
    ...
    get prices() {
        return {
            list: (params = {}) => this.safeRequest(
                ...
                'prices.list',
                { lookup_keys: params.lookup_keys, limit: params.limit }
            ),
            
            retrieve: (priceId, params = {}) => this.safeRequest(
                () => this.stripe.prices.retrieve(priceId, params),
                'prices.retrieve',
                { priceId, expand: params.expand }
            )
        };
    }
    ...
    get checkout() {
        return {
            sessions: {
                ...
                retrieve: (sessionId, params = {}) => this.safeRequest(
