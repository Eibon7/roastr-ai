...
const { validatePassword: validatePasswordStrength, getPasswordStrength } = require('../utils/passwordValidator');
...
class PasswordValidationService {
     ...
     */
    async validatePasswordForSensitiveOperation(userId, providedPassword, storedPasswordHash, operation = 'sensitive_operation') {
     ...
     */
    async validatePasswordChange(userId, currentPassword, newPassword, confirmPassword, storedPasswordHash) {
