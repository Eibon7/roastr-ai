...
const tierMessages = {
  ...
  analysis: {
    free: {
      limit_exceeded:
        'Has alcanzado tu límite mensual de 100 análisis. Mejora a Starter para obtener 1,000 análisis mensuales.',
    ...
    starter: {
      limit_exceeded:
        'Has alcanzado tu límite mensual de 1,000 análisis. Mejora a Pro para obtener 10,000 análisis mensuales.',
      near_limit: 'Te quedan pocos análisis este mes. Mejora tu plan para obtener más análisis.',
      upgrade_cta: 'Mejora a Pro por €15/mes para obtener 10x más análisis.'
    },
    pro: {
      limit_exceeded:
        'Has alcanzado tu límite mensual de 10,000 análisis. Mejora a Plus para obtener 100,000 análisis mensuales.',
      near_limit: 'Te quedan pocos análisis este mes. Mejora tu plan para obtener más análisis.',
      upgrade_cta: 'Mejora a Plus por €50/mes para obtener 10x más análisis.'
    },
    plus: {
      limit_exceeded:
        'Has alcanzado tu límite mensual de 100,000 análisis. Contacta con soporte para opciones enterprise.',
  ...
  roast: {
    free: {
      limit_exceeded:
        'Has alcanzado tu límite mensual de 10 roasts. Mejora a Starter para obtener 100 roasts mensuales.',
    ...
    starter: {
      limit_exceeded:
        'Has alcanzado tu límite mensual de 100 roasts. Mejora a Pro para obtener 1,000 roasts mensuales.',
      near_limit: 'Te quedan pocos roasts este mes. Mejora tu plan para obtener más roasts.',
      upgrade_cta: 'Mejora a Pro por €15/mes para obtener 10x más roasts.'
    },
    pro: {
      limit_exceeded:
        'Has alcanzado tu límite mensual de 1,000 roasts. Mejora a Plus para obtener 5,000 roasts mensuales.',
      near_limit: 'Te quedan pocos roasts este mes. Mejora tu plan para obtener más roasts.',
      upgrade_cta: 'Mejora a Plus por €50/mes para obtener 5x más roasts.'
    },
    plus: {
      limit_exceeded:
        'Has alcanzado tu límite mensual de 5,000 roasts. Contacta con soporte para opciones enterprise.',
  ...
  platform: {
    free: {
      limit_exceeded:
        'Solo puedes conectar 1 cuenta por red social en el plan Free. Mejora a Pro para conectar 2 cuentas por red.',
      upgrade_cta: 'Mejora a Pro por €15/mes para conectar múltiples cuentas.'
    },
    starter: {
      limit_exceeded:
        'Solo puedes conectar 1 cuenta por red social en el plan Starter. Mejora a Pro para conectar 2 cuentas por red.',
      upgrade_cta: 'Mejora a Pro por €15/mes para conectar múltiples cuentas.'
    },
    pro: {
  ...
  features: {
    shield: {
      not_available:
        'Shield está disponible desde el plan Starter. Mejora tu plan para activar la protección automática.',
      upgrade_cta: 'Mejora a Starter por €5/mes para activar Shield.'
    },
    ENABLE_ORIGINAL_TONE: {
      not_available:
        'Original Tone está disponible desde el plan Pro. Mejora tu plan para personalizar completamente tus roasts.',
      upgrade_cta: 'Mejora a Pro por €15/mes para activar Original Tone.'
    },
    embedded_judge: {
      not_available:
        'Embedded Judge está disponible solo en el plan Plus. La función más avanzada de personalización.',
  ...
  planChange: {
    ...
    downgrade: {
      scheduled:
        'Downgrade programado para el siguiente ciclo de facturación. Mantienes tu plan actual hasta entonces.',
      usage_exceeds:
        'No puedes hacer downgrade ahora porque tu uso actual excede los límites del nuevo plan. Inténtalo en el siguiente ciclo.',
  ...
  upgradeCtas: {
    ...
    starter_to_pro: {
      ...
      price: '€15/mes',
      benefits: [
        '10,000 análisis mensuales',
        '1,000 roasts mensuales',
        'Original Tone',
        '2 cuentas por red'
      ],
      cta: 'Mejorar ahora'
    ...
    pro_to_plus: {
      ...
      price: '€50/mes',
      benefits: [
        '100,000 análisis mensuales',
        '5,000 roasts mensuales',
        'Embedded Judge',
        'Soporte dedicado'
      ],
      cta: 'Mejorar ahora'
...
function getPlanChangeMessage(changeType, status) {
  return tierMessages.planChange[changeType]?.[status] || 'Estado de cambio de plan desconocido.';
}
