...
describe('BaseTag (migrated to shadcn Badge)', () => {
  it('renders label', () => {
    render(<BaseTag label="CRITICAL" color="#FF0000" />);

    expect(screen.getByText('CRITICAL')).toBeInTheDocument();
  });

  it('applies custom color', () => {
    render(<BaseTag label="TEST" color="#00FF00" />);
  ...
  it('applies transparent background when isTransparent is true', () => {
    render(<BaseTag label="TRANSPARENT" color="#0000FF" isTransparent={true} />);
  ...
  it('applies custom text color', () => {
    render(<BaseTag label="CUSTOM TEXT" color="#FF0000" textColor="#FFFFFF" />);
  ...
  it('applies title attribute', () => {
    render(<BaseTag label="TEST" color="#000000" title="Test tooltip" />);
  ...
  it('applies default title if not provided', () => {
    render(<BaseTag label="DEFAULT" color="#000000" />);
