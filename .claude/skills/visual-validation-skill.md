...
- contexto: "Cambios en formulario de login"
  accion: | 1. Navegar a /login 2. Capturar estado inicial 3. Simular focus en input de email 4. Capturar estado de error al submit incorrecto 5. Validar que contraste cumple WCAG AA
