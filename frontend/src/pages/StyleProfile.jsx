                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground mb-4">
                      ...
                      We'll examine your tone, humor patterns, and language preferences across
                      platforms.
                    </p>
                    ...
                    {integrationStatus.length > 0 ? (
                      ...
                      <div className="flex items-center space-x-2 text-orange-600">
                        ...
                        <span className="text-sm">Connect platforms and import content first</span>
                      </div>
                    )}
                  </div>
                </div>
                    ...
                    <Card className="border-purple-200">
                      <CardHeader>
                        <CardTitle className="flex items-center space-x-2">
                          ...
                          <span>
                            {LANGUAGE_NAMES[selectedLanguage] || selectedLanguage.toUpperCase()}{' '}
                            Style Profile
                          </span>
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <Button
                              onClick={() =>
                                handleCopyPrompt(getSelectedProfile().prompt, selectedLanguage)
                              }
                              size="sm"
                              variant="outline"
                            >
                        ...
                        <div className="grid md:grid-cols-3 gap-4 pt-4 border-t">
                          <div>
                            ...
                            <div className="font-medium">
                              {getSelectedProfile().metadata.totalItems} items
                            </div>
                          </div>
                          <div>
                            <div className="text-xs text-muted-foreground">Avg Length</div>
                            <div className="font-medium">
                              {getSelectedProfile().metadata.avgLength} chars
                            </div>
                          </div>
                          <div>
                            <div className="text-xs text-muted-foreground">Dominant Tone</div>
                            <div className="font-medium capitalize">
                              {getSelectedProfile().metadata.dominantTone}
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          <label className="text-xs text-muted-foreground mb-1 block">
                            Sources for {LANGUAGE_NAMES[selectedLanguage]}:
                          </label>
                          <div className="flex flex-wrap gap-1">
                            {Object.entries(getSelectedProfile().sources).map(
                              ([platform, count]) => (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-muted-foreground">
                      Your personalized AI style profile has been generated and saved. You can now
                      use these prompts for generating roasts or view them anytime from your
                      dashboard.
                    </p>
                  </div>
