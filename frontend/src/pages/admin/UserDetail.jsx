...
const UserDetail = () => {
  ...
  const handleReAuthIntegrations = async () => {
    if (
      !window.confirm(`¿Estás seguro de que quieres invalidar las integraciones de ${user.email}?`)
    ) {
      return;
    }
  ...
  const handleDeleteAccount = async () => {
    const confirm1 = window.confirm(
      `¿Estás seguro de que quieres eliminar la cuenta de ${user.email}?`
    );
    if (!confirm1) return;
    ...
    <>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700 dark:text-yellow-200">
              <strong>Vista de superusuario</strong> – actuando sobre la cuenta de{' '}
        ...
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-4">
            ...
            <li className="flex items-center">
              ...
              <span className="ml-4 text-sm font-medium text-gray-500">Detalles de Usuario</span>
            </li>
          </ol>
        </nav>
      </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-xs text-gray-500">de {stats.plan_limits.monthly_tokens} límite</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-semibold text-gray-900">{stats.usage_alerts.length}</p>
              <p className="text-xs text-gray-500">
              ...
              >
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-600 mt-1">Categoría: {alert.category}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Editar configuraciones del usuario desde el panel de administración
          </p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  Protección automática contra toxicidad
                </p>
              </div>
              <div>
                <input
                  ...
                  onChange={(e) =>
                    setEditableConfig({ ...editableConfig, shieldEnabled: e.target.checked })
                  }
                />
              </div>
            </div>
            <div className="flex items-center justify-between">
              ...
              <div>
                <input
                  ...
                  onChange={(e) =>
                    setEditableConfig({ ...editableConfig, autoReplyEnabled: e.target.checked })
                  }
                />
              </div>
            </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditableConfig({
                      ...editableConfig,
                      persona: { ...editableConfig.persona, defines: e.target.value }
                    })
                  }
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditableConfig({
                      ...editableConfig,
                      persona: { ...editableConfig.persona, doesntTolerate: e.target.value }
                    })
                  }
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setEditableConfig({
                      ...editableConfig,
                      persona: { ...editableConfig.persona, doesntCare: e.target.value }
                    })
                  }
                />
              </div>
        ...
        <div className="bg-white shadow rounded-lg">
          ...
          <div className="px-6 py-4 space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-900">{user.active ? 'Activa' : 'Inactiva'}</p>
            </div>
            <div>
              <label className="text-sm font-medium text-gray-600">Suspendida</label>
              <p className="text-sm text-gray-900">{user.suspended ? 'Sí' : 'No'}</p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-900">{user.is_admin ? 'Sí' : 'No'}</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg mb-6">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
            Operaciones administrativas sobre la cuenta del usuario
          </p>
        </div>
        <div className="px-6 py-4">
                        ...
                        {roast.toxicity_score && (
                          <span
                            className={`px-2 py-1 rounded ${
                              roast.toxicity_score > 0.7
                                ? 'bg-red-100 text-red-800'
                                : roast.toxicity_score > 0.5
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-medium text-gray-900">
              Comentarios Interceptados por Shield
            </h3>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <p className="text-sm font-medium text-gray-900">
                          Comentario Interceptado:
                        </p>
                        <p className="text-sm text-gray-700 mb-2 italic">
                          "{intercept.comment_text}"
                        </p>
                        <p className="text-sm font-medium text-gray-900">Acción Tomada:</p>
                        <p className="text-sm text-red-600 font-medium capitalize">
                          {intercept.action_taken}
                        </p>
                      </div>
                    </div>
