    ...
    <div className="min-h-full">
      <div className="text-center py-12">
        ...
        <p className="mt-2 text-gray-500 dark:text-gray-400 max-w-md mx-auto">
          Esta sección incluirá configuraciones del sistema, gestión de integraciones, límites de planes y configuraciones globales.
        </p>
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h4 className="text-lg font-medium text-gray-900 dark:text-white">Límites de Planes</h4>
                <p className="text-sm text-gray-500 dark:text-gray-400">Configurar límites por plan</p>
              </div>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Gestionar APIs de redes sociales</p>
              </div>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Configuraciones de seguridad</p>
              </div>
            </div>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">Configurar precios y planes</p>
              </div>
            </div>
          </div>
        </div>
