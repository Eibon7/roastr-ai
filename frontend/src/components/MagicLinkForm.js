  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        setEmailSent(true);
        onSuccess?.(
          'Te hemos enviado un enlace mágico a tu correo electrónico. Revisa tu bandeja de entrada.',
          result
        );
      } else if (isRegister) {
        ...
        setEmailSent(true);
        onSuccess?.(
          'Te hemos enviado un enlace mágico para crear tu cuenta. Revisa tu bandeja de entrada.',
          result
        );
      }
    } catch (error) {
      ...
      <div className="text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Te hemos enviado un enlace mágico a <strong>{formData.email}</strong>. Haz clic en el
            enlace para {isLogin ? 'iniciar sesión' : 'crear tu cuenta'}.
          </p>
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          {isLogin ? 'iniciar sesión' : 'crear tu cuenta'} sin contraseña.
        </p>
      </div>
