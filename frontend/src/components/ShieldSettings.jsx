...
const ShieldSettings = ({ settings, onChange, disabled = false }) => {
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <label
              key={preset.id}
              className="relative flex flex-col p-3 border rounded-lg cursor-pointer hover:bg-gray-50 disabled:opacity-50"
            >
              <input
                type="radio"
                name="preset"
              ...
              />
              <div
                className={`text-sm font-medium ${settings.preset === preset.id ? 'text-blue-700' : 'text-gray-900'}`}
              >
                {preset.label}
              </div>
