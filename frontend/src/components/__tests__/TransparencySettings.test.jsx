...
describe('TransparencySettings', () => {
  ...
  it('should load and display transparency settings', async () => {
    ...
    expect(screen.getByText('Algunos mensajes de hate son respondidos automáticamente por @Roastr')).toBeInTheDocument();
  });
  ...
  it('should handle creative mode correctly', async () => {
    ...
    expect(screen.getByText('Este roast fue generado por IA. Tranquilo: ningún humano perdió tiempo en ti.')).toBeInTheDocument();
  ...
  it('should handle API errors gracefully', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Error al cargar la configuración de transparencia')).toBeInTheDocument();
    });
  });
  ...
  it('should handle update errors gracefully', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Error al actualizar la configuración de transparencia')).toBeInTheDocument();
    });
  });
  ...
  it('should clear success/error messages after delay', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('Configuración de transparencia actualizada correctamente')).toBeInTheDocument();
    });
    ...
    await waitFor(() => {
      expect(screen.queryByText('Configuración de transparencia actualizada correctamente')).not.toBeInTheDocument();
    });
