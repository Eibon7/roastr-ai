...
const TransparencySettings = () => {
  ...
  const generatePlatformBioTexts = (baseBioText) => {
    const platforms = {
      ...
      youtube: {
        name: 'YouTube',
        charLimit: 1000,
        text: baseBioText + ' | Algunas respuestas en comentarios son generadas con inteligencia artificial para mantener conversaciones constructivas.',
        icon: '📺'
      }
    };
  ...
  const copyBioText = async (platformKey = null) => {
    try {
      const textToCopy = platformKey && platformBioTexts[platformKey] 
        ? platformBioTexts[platformKey].text 
        : bioText;
      ...
      const platformName = platformKey && platformBioTexts[platformKey] 
        ? platformBioTexts[platformKey].name 
        : '';
  ...
  const transparencyOptions = [
    {
      ...
      description: 'Añades el texto sugerido en tu bio una sola vez. Los roasts se publican sin modificaciones.',
      detailedDescription: 'La opción más limpia y profesional. Perfecto si usas Roastr ocasionalmente o prefieres mantener tus roasts sin modificaciones.',
    ...
    },
    {
      ...
      detailedDescription: 'Una firma consistente y reconocible en cada roast. Transparencia clara sin ser intrusiva.',
      pros: ['Transparencia en cada roast', 'Consistente y reconocible', 'No requiere cambios en bio'],
    ...
    },
    {
      ...
      description: 'Cada roast termina con un disclaimer aleatorio divertido que mantiene el tono humor.',
      detailedDescription: 'Variedad y diversión en cada roast. Los disclaimers cambian para mantener el interés y el tono divertido.',
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start space-x-2">
          ...
          <div className="text-sm text-blue-800">
            <p className="mb-3">
              <strong>¿Por qué es importante?</strong> Por cumplimiento de las políticas de OpenAI y redes sociales, 
              es recomendable identificar cuando las respuestas son generadas por IA. No es una obligación pesada, 
              sino una práctica ética que mantiene la confianza con tu audiencia.
            </p>
            <p className="mb-2">
        ...
        <div className="flex items-start space-x-2">
          ...
          <div className="text-sm text-yellow-800">
            ...
            <div className="mt-2 text-xs">
              <p><strong>• Modo Bio:</strong> Ideal si publicas ocasionalmente - mencionas Roastr una vez en tu bio</p>
              <p><strong>• Firma Clásica:</strong> Perfecto para uso regular - cada roast incluye una firma discreta</p>
              <p><strong>• Disclaimers Creativos:</strong> Para usuarios frecuentes - añade variedad con mensajes divertidos</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="border border-gray-200 rounded-lg p-4 bg-yellow-50">
                ...
                <div className="bg-white border border-gray-300 rounded p-3 mb-3">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-medium text-sm">{platformBioTexts[selectedPlatform].name}</span>
                    </div>
                    <div className="text-xs text-gray-500">
                      {platformBioTexts[selectedPlatform].text.length}/{platformBioTexts[selectedPlatform].charLimit} caracteres
                    </div>
                  </div>
          ...
          <div className="text-xs text-gray-600 space-y-2">
            <div className="bg-white bg-opacity-50 rounded p-2">
              <p className="font-medium mb-2">📋 <strong>Instrucciones paso a paso:</strong></p>
            ...
            <div className="bg-blue-50 bg-opacity-50 rounded p-2">
              <p className="font-medium text-blue-800">💡 <strong>Nuevas funcionalidades:</strong></p>
              <ul className="list-disc list-inside space-y-1 text-blue-700">
                <li><strong>Optimización automática:</strong> Cada plataforma tiene un texto adaptado a sus límites</li>
                <li><strong>Contador de caracteres:</strong> Verifica que el texto cabe en el límite de cada plataforma</li>
                <li><strong>Multi-plataforma:</strong> Textos específicos para Twitter, Instagram, LinkedIn, TikTok y YouTube</li>
                <li><strong>Flexibilidad total:</strong> Puedes usar el texto original o las variantes optimizadas</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      {(currentMode === 'signature' || currentMode === 'creative') && (
        <div className="border border-gray-200 rounded-lg p-4 bg-green-50">
          <div className="text-sm font-medium mb-4 text-gray-900 flex items-center space-x-2">
            ...
            <span>Vista previa de {currentMode === 'signature' ? 'firmas' : 'disclaimers creativos'}</span>
          </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded p-3">
                <div className="text-xs text-blue-800">
                  ...
                  <ul className="space-y-1 list-disc list-inside">
                    <li><strong>Consistente:</strong> Siempre la misma firma en cada roast</li>
                    <li><strong>Profesional:</strong> Texto serio y directo</li>
                    <li><strong>Compacta:</strong> Solo 22 caracteres, mínimo impacto</li>
                    <li><strong>Reconocible:</strong> Fácil identificación de contenido IA</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <div className="bg-white border rounded-lg p-4">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={index} className="bg-gray-50 rounded p-3 border-l-4 border-purple-400">
              ...
              <div className="bg-purple-50 border border-purple-200 rounded p-3">
                <div className="text-xs text-purple-800">
                  <div className="font-medium mb-2">🎭 Características de disclaimers creativos:</div>
                  <ul className="space-y-1 list-disc list-inside">
                    <li><strong>Variedad:</strong> Más de 10 disclaimers diferentes que rotan aleatoriamente</li>
                    <li><strong>Humor integrado:</strong> Mantienen el tono sarcástico y divertido</li>
                    <li><strong>Transparencia clara:</strong> Identifican claramente el uso de IA</li>
                    <li><strong>Engagement:</strong> Los lectores pueden disfrutar la variedad</li>
                    <li><strong>Adaptativo:</strong> Se selecciona automáticamente el mejor según el contexto</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded p-3">
                <div className="text-xs text-yellow-800 flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <p>El sistema selecciona automáticamente el disclaimer más apropiado basándose en:</p>
            ...
            <div>
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded p-3">
                <div className="text-xs text-yellow-800">
                  <strong>📄 Tu bio incluye:</strong> "{bioText || 'Algunas respuestas generadas con ayuda de IA.'}"
                </div>
              </div>
            </div>
          )}
        ...
        <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded text-xs text-green-800">
          <div className="flex items-start space-x-2">
            ...
            <div>
              ...
              <p>Todos los roasts futuros usarán tu configuración seleccionada. Los roasts anteriores no se modifican.</p>
            </div>
          </div>
        </div>
      </div>
