...
describe('Shop Component', () => {
  ...
  describe('Addon Descriptions', () => {
    ...
    it('should show detailed description for Shield Pro', () => {
      ...
      expect(screen.getByText(/Protección avanzada contra contenido inapropiado/i)).toBeInTheDocument();
    });

    it('should show detailed description for Roast Boost', () => {
      renderComponent();
      
      expect(screen.getByText(/Generación de roasts más rápida y con mayor creatividad/i)).toBeInTheDocument();
    });
