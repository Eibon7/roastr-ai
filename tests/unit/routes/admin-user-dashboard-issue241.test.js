...
describe('Admin User Dashboard Routes - Issue #241', () => {
  ...
  describe('GET /api/admin/users/:userId/activity', () => {
    test('should fetch user activity data successfully', async () => {
      ...
      const response = await request(app).get('/api/admin/users/user-123/activity').expect(200);
    ...
    test('should respect limit parameter', async () => {
      ...
      await request(app).get('/api/admin/users/user-123/activity?limit=5').expect(200);
