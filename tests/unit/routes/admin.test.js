...
describe('Admin Routes', () => {
  ...
  describe('GET /api/admin/dashboard', () => {
    ...
    test('should handle metricsService errors gracefully', async () => {
      ...
      const response = await request(app).get('/api/admin/dashboard').expect(500);
  ...
  describe('POST /api/admin/integrations/test', () => {
    ...
    test('should handle integration test failure', async () => {
      ...
      const response = await request(app).post('/api/admin/integrations/test').send({}).expect(500);
  ...
  describe('GET /api/admin/config', () => {
    test('should return system configuration', async () => {
      ...
      const response = await request(app).get('/api/admin/config').expect(200);
  ...
  describe('GET /api/admin/logs', () => {
    ...
    test('should handle logs fetch error with fallback data', async () => {
      ...
      const response = await request(app).get('/api/admin/logs').expect(200);
  ...
  describe('GET /api/admin/logs/download', () => {
    test('should download logs as text file', async () => {
      ...
      const response = await request(app).get('/api/admin/logs/download').expect(200);
  ...
  describe('POST /api/admin/users/:userId/reactivate', () => {
    test('should reactivate user successfully', async () => {
      ...
      const response = await request(app).post(`/api/admin/users/${userId}/reactivate`).expect(200);
    ...
    test('should handle reactivate user error', async () => {
      ...
      const response = await request(app).post(`/api/admin/users/${userId}/reactivate`).expect(500);
  ...
  describe('GET /api/admin/users/:userId - Issue #235', () => {
    test('should return detailed user information', async () => {
      ...
      const response = await request(app).get(`/api/admin/users/${userId}`).expect(200);
    ...
    test('should handle user not found', async () => {
      ...
      const response = await request(app).get(`/api/admin/users/${userId}`).expect(404);
