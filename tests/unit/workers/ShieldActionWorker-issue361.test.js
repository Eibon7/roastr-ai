...
describe('ShieldActionWorker (Issue 361)', () => {
  ...
  describe('Job Processing', () => {
    ...
    test('should validate required job parameters', async () => {
      ...
      await expect(worker.processJob({ payload: invalidPayload })).rejects.toThrow(
    ...
    test('should handle executor errors and update metrics', async () => {
      ...
      await expect(worker.processJob({ payload: validJobPayload, id: 'job-128' })).rejects.toThrow(
