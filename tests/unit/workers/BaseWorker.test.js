 ...
 * BaseWorker Tests
 * 
 * Tests for the foundational worker class that all other workers extend.
 * Covers:
...
describe('BaseWorker', () => {
  ...
  describe('connection initialization', () => {
    test('should initialize Supabase client with correct parameters', () => {
      worker = new TestWorker();
      ...
      expect(worker.supabase).toBe(mockSupabaseClient);
      expect(worker.queueService).toBeInstanceOf(QueueService.mock.results[0].value.constructor);
    });
