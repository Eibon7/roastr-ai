...
} = require('../../../src/middleware/usageEnforcement');
...
describe('UsageEnforcementMiddleware', () => {
  ...
  describe('checkLimit', () => {
    it('should allow action when under limit', async () => {
      ...
      expect(mockEntitlementsService.checkUsageLimit).toHaveBeenCalledWith(
        'test-user-123',
        'analysis'
      );
  ...
  describe('incrementUsage', () => {
    it('should increment usage after successful response', async () => {
      ...
      expect(mockEntitlementsService.incrementUsage).toHaveBeenCalledWith(
        'test-user-123',
        'analysis',
        1
      );
