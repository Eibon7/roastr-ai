...
describe('EncryptionService Performance Benchmarks', () => {
  ...
  describe('Encryption Performance by Text Size', () => {
    it('should encrypt 10-character text efficiently', async () => {
      ...
      console.log(
        `Encrypt 100x 10-char texts: ${time.toFixed(2)}ms (avg: ${(time / iterations).toFixed(2)}ms per operation)`
      );
    ...
    it('should encrypt 100-character text efficiently', async () => {
      ...
      console.log(
        `Encrypt 100x 100-char texts: ${time.toFixed(2)}ms (avg: ${(time / iterations).toFixed(2)}ms per operation)`
      );
    ...
    it('should encrypt 500-character text efficiently', async () => {
      ...
      console.log(
        `Encrypt 50x 300-char texts: ${time.toFixed(2)}ms (avg: ${(time / iterations).toFixed(2)}ms per operation)`
      );
      expect(time).toBeLessThan(200);
    });
    ...
    it('should encrypt maximum 300-character text efficiently', async () => {
      ...
      console.log(
        `Encrypt 50x 300-char texts (max size): ${time.toFixed(2)}ms (avg: ${(time / iterations).toFixed(2)}ms per operation)`
      );
      expect(time).toBeLessThan(200);
    });
  });
  ...
  describe('Decryption Performance by Text Size', () => {
    ...
    it('should decrypt 10-character texts efficiently', async () => {
      ...
      console.log(
        `Decrypt 100x 10-char texts: ${time.toFixed(2)}ms (avg: ${(time / iterations).toFixed(2)}ms per operation)`
      );
      expect(time).toBeLessThan(200);
    });
    ...
    it('should decrypt 100-character texts efficiently', async () => {
      ...
      console.log(
        `Decrypt 100x 100-char texts: ${time.toFixed(2)}ms (avg: ${(time / iterations).toFixed(2)}ms per operation)`
      );
      expect(time).toBeLessThan(250);
    });
    ...
    it('should decrypt 300-character texts efficiently', async () => {
      ...
      console.log(
        `Decrypt 50x 300-char texts: ${time.toFixed(2)}ms (avg: ${(time / iterations).toFixed(2)}ms per operation)`
      );
      expect(time).toBeLessThan(200);
    });
  });
  ...
  describe('Round-trip Performance (Encrypt + Decrypt)', () => {
    it('should handle complete round-trip operations efficiently', async () => {
      ...
      console.log(
        `50x complete round-trips (100 chars): ${time.toFixed(2)}ms (avg: ${(time / iterations).toFixed(2)}ms per round-trip)`
      );
