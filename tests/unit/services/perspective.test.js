...
describe('Perspective Service Tests', () => {
    ...
    describe('analyzeToxicity method', () => {
        it('should throw error if no API key configured', async () => {
            ...
            await expect(serviceWithoutKey.analyzeToxicity('test text'))
                .rejects
                .toThrow('Perspective API key not configured');
        });

        it('should throw error for invalid text input', async () => {
            await expect(perspectiveService.analyzeToxicity(null))
                .rejects
                .toThrow('Invalid text input for toxicity analysis');

            await expect(perspectiveService.analyzeToxicity(123))
                .rejects
                .toThrow('Invalid text input for toxicity analysis');
        });
    ...
    describe('Error handling', () => {
        it('should handle 400 Bad Request errors', async () => {
            ...
            await expect(perspectiveService.analyzeToxicity('test'))
                .rejects
                .toThrow('Invalid request to Perspective API: API key not valid');
        });
        ...
        it('should handle 401 Unauthorized errors', async () => {
            ...
            await expect(perspectiveService.analyzeToxicity('test'))
                .rejects
                .toThrow('Perspective API authentication failed - check API key');
        });
