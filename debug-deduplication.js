...
async function testDeduplication() {
  try {
    ...
    worker.fetchCommentsFromPlatform = async () => {
      console.log('fetchCommentsFromPlatform called, returning comment:', comment.platform_comment_id);
      return [comment];
    };
    ...
    console.log('Actual: First job =', result1.commentsCount, 'comments, Second job =', result2.commentsCount, 'comments');
