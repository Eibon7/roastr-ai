...
**Solution:** Same as M1, replace all console._ with logger._
...
- [ ] Both scripts use logger._ instead of console._
...
**Batch Operation:** Replace console._ → logger._ in 4 remaining scripts
...
- Document console._ → logger._ migration across verification scripts
