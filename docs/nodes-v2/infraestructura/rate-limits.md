...
| roast (rate limit) | Generación de roasts | 10 | 1 min |
| persona (rate limit) | Updates de persona | 3 | 1 hora |
...
- `ratelimit:roast:user:uuid-456` - Rate limit scope roast por usuario
