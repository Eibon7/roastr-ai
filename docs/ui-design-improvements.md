...
**Media:** 4. Typography scale (legibilidad) 5. Hover & active states (feedback) 6. Border radius (modernidad)

**Baja:** 7. Custom animations (delight) 8. Illustration system (branding avanzado) 9. Dark mode refinement (nice-to-have)
