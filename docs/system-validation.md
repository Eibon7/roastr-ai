...
| observability | coverage_integrity_violation | 14% | 4% | 10% | critical |
...
- Coverage data not available for validation
- Coverage data not available for validation
- Coverage mismatch: declared 14% but actual is 4% (diff: 10%)
- Coverage data not available for validation
- Coverage data not available for validation
- Coverage mismatch: declared 17% but actual is 6% (diff: 11%)
- Coverage mismatch: declared 32% but actual is 0% (diff: 32%)
- Coverage data not available for validation
- Coverage data not available for validation
