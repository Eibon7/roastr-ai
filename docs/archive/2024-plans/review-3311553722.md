...
**Fase 2: CodeRabbit Critical** 2. **C1**: Workflow failure handling

- Validar que snapshot existe antes de set outputs.status
- Fallar si collector no generó snapshot

**Fase 3: CodeRabbit Major** 3. **M1**: Skip auto-commit en PRs
...
**Fase 4: CodeRabbit Minor** 5. **MIN1**: Markdown linting
