...
**Major (P1):** 2. **Incorrect status persistence** (src/workers/PublisherWorker.js:242-270)
...
**Minor:** 4. **Date inconsistency in documentation** (docs/nodes/social-platforms.md:792-793)

- File: docs/nodes/social-platforms.md
- Impact: Documentation metadata mismatch
- Fix: Update header date to 2025-10-04

**Nit:** 5. **Typo in method name** (docs/plan/issue-410.md:84-127)
