...
## 🎯 FASE 0 - Assessment (OBLIGATORIO)

### 1. Lessons Learned
- [ ] Leer: `docs/patterns/coderabbit-lessons.md`
- [ ] Identificar patrones conocidos (≥2 comentarios = actualizar después)
...
# - logBackupService.js → observability, queue-system
# - admin-plan-limits → multi-tenant, cost-control
# - logCommands.test.js → observability
```
...
**Agentes esperados:**
- ✅ TestEngineer (tests modificados)
- ✅ Guardian (si hay cambios en RLS/security)

### 4. CodeRabbit Comments (Placeholder - completar con revisión real)

**⚠️ NOTA: Actualizar con comentarios reales de https://github.com/Eibon7/roastr-ai/pull/805#pullrequestreview-3447334692**
...
- Otros según revisión CodeRabbit
...
```markdown
#### Comentario #X - [Severity] - archivo:línea
...
**Fix:**
- [ ] Aplicar sugerencia
- [ ] Buscar patrón en TODO el codebase
- [ ] Aplicar consistency
- [ ] Tests afectados
...
### Comandos de Verificación (EJECUTAR TODOS)
...
# Patrón: Issues → Fixes → Testing → Results (NO cronología)
```
...
- [ ] N archivos modificados, M tests añadidos
- [ ] Coverage: A%→B% (≥90%)
- [ ] Tests: 0 failures (verificado)
- [ ] GDD: Health ≥87, Drift <60 (verificado)
- [ ] spec.md: [sección o N/A]
...
1. **COMPLETAR** con comentarios reales de la revisión CodeRabbit
2. **NO SALTAR** FASE 0
3. **EJECUTAR** comandos reales de verificación (no asumir)
