...
**Auto-Repair Config:** 5. `.gddrc.json` - Add exclusions or modify behavior

**Scripts Modified:** 6. `scripts/validate-gdd-runtime.js` or similar - Fix template (if Option A for C2)
