...
- **Impact:** Violates src/\*_/_.js guidelines, not using centralized logger
...
3. **M1: Sequential state-mutating handlers**
   - Categorize handlers:
     - State-mutating: block*user, mute*\*, manual_review (user_behaviors write)
     - Non-mutating: hide*comment, log*\*
...
- [x] No console.log in src/\*_/_.js
